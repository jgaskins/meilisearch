...
private def test_with_index(name, *, primary_key : String? = nil, **options, &block : Meilisearch::Index, Meilisearch::Client ->)
  test name, **options do |index_uid, client|
...
private def test(name, **options, &block : String, Meilisearch::Client ->)
  it name, **options do
    client = Meilisearch::Client.new
